...
function Update(self)
	...
	if self.Work == true then
		...
		if self.Overheat == true then
			local Effect = CreateAEmitter("Wehrmacht.rte/Overheat")
			Effect.Pos = self.Pos + Vector(math.random(5,10),0):RadRotate(self.parent:GetAimAngle(true))
