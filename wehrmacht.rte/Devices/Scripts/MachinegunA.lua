function Create(self)
  self.BipodOffset = Vector(14, 4) --Where the Bipod is on the gun
  self.PinDepth = 1 --How deep the bipod is stuck into the ground
  self.BipodStanceOffset = Vector(10, -4) --Where the actor is relative to the gun when the gun is pinned
