function Create(self)
  self.BipodOffset = Vector(-15, 0) --Where the Bipod is on the gun
  self.PinDepth = 0 --How deep the bipod is stuck into the ground
  self.BipodStanceOffset = Vector(-2, 13) --Where the actor is relative to the gun when the gun is pinned
